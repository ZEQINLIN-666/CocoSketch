...
control egress {
     // There is no enough resource in the ingress pipeline.
     // Therefore, the final 2 steps are placed here in the egress pipeline.
